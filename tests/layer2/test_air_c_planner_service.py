...
def test_air_request_plans_air_c_before_air_a_for_dg():
...
def test_air_request_non_dg_plans_air_c_air_e_for_now():
...
def test_layer2_service_air_runs_air_c_and_air_a_for_dg():
    request = _air_request(
        dangerous_goods=FlagState.yes,
        un_number="UN3480",
    )
